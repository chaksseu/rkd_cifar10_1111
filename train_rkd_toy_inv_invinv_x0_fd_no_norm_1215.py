...
def build_argparser():
    ...
    p.add_argument("--output_dir", type=str, default=f"out_1215_rkd_cifar10_rgb_to_gray_single_batch{BATCH_SIZE}_N{CLASSN}-FD-rkdW{RKD_W}-invW{INV_W}-invinvW{INVINV_W}-fdW{FD_W}-sameW{SAME_W}")
    ...
    p.add_argument("--run_name", type=str, default=f"student-x0-pixel-rgb-to-gray-batch{BATCH_SIZE}-N{CLASSN}-FD-rkdW{RKD_W}-invW{INV_W}-invinvW{INVINV_W}-fdW{FD_W}-sameW{SAME_W}")
